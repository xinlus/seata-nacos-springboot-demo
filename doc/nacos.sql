...
-- ----------------------------
INSERT INTO `config_info` VALUES (4, 'seataServer.properties', 'SEATA_GROUP', '# 存储模式\nstore.mode=db\n\nstore.db.datasource=druid\nstore.db.dbType=mysql\n# 需要根据mysql的版本调整driverClassName\n# mysql8及以上版本对应的driver：com.mysql.cj.jdbc.Driver\n# mysql8以下版本的driver：com.mysql.jdbc.Driver\nstore.db.driverClassName=com.mysql.cj.jdbc.Driver\n# 注意根据生产实际情况调整参数host和port\nstore.db.url=jdbc:mysql://127.0.0.1:3306/seata?useUnicode=true&characterEncoding=utf8&connectTimeout=1000&socketTimeout=3000&autoReconnect=true&useSSL=false\n# 数据库用户名\nstore.db.user=root\n# 用户名密码\nstore.db.password=root\n\nservice.vgroupMapping.default_tx_group=default\n#1.5版本之前解决日期反序列化问题，1.5之后不用\n#client.undo.logSerialization=kryo', '076a339abada513775b8764ae21d7e41', '2022-06-23 02:38:34', '2022-07-07 05:43:43', 'nacos', '0:0:0:0:0:0:0:1', '', '', '', '', '', 'properties', '');
